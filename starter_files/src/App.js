              ...
              <div className="card-block">
                ...
                <form onSubmit = {this.handleFormSubmit}>
                  <div className="form-group">
                    <textarea onChange={this.handleCommentTextChange} value = {this.state.commentText}className="form-control" name="comment"  rows="3" type="text" />
                  </div>
                  <div className="form-group">
                    <input onChange= {this.handleNameChange} value = {this.state.name}lassName="form-control col-md-3" name="name"  type="text"/>
                  </div>
